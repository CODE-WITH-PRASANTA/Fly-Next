...
import "./TrainingFaq.css"; // Import CSS
...
const TrainingFaq = () => {
  ...
  return (
    <div className="full-faq-sec">
      <div className="Training-faq-container">
        {/* Left Section */}
        ...
        <div className="faq-right">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`Training-faq-item ${openIndex === index ? "open" : ""}`}
            ...
            >
              ...
              <div className="Training-faq-answer" style={{ maxHeight: openIndex === index ? "100px" : "0px" }}>
                {faq.answer}
              </div>
            </div>
          ))}
